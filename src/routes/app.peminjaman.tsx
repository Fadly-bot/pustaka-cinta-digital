  ...
  const { data: list, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from("peminjaman")
        .select("*, peminjam:peminjam_id(nama, kode_peminjam), detail_peminjaman!detail_peminjaman_peminjaman_fkey(id, buku_id, jumlah, buku!detail_peminjaman_buku_id_fkey(judul))")
